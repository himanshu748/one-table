export type Brief = { title:string; city:string; eventDate:string; headcount:number; dietary:"veg"|"nonveg"|"both"; needs?:string[]; budgetHint?:number|null; neighbourhood?:string; dateFlexible?:boolean; eventType?:string };
